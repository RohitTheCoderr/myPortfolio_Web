...
function Contact() {
    ...
    return (
        <section className="w-full relative bg-cover py-4 bg-black">
            ...
            <div className="h-auto w-full relative pt-8">
                <div className="h-auto w-auto m-auto flex justify-around flex-wrap-reverse gap-4">
                    <div className="h-auto bg-white/5 backdrop-blur-lg py-2">
                        <h1 className="text-white text-2xl font-semibold text-center underline">Contact Information</h1>
                        <div className="w-[80%] m-auto sm:w-[70%] md:w-[30rem] sm:px-2 mt-10">
                            <div className="flex gap-4 my-4">
                                <FaMobileAlt className="text-xl text-white" />
                                <span className="text-white text-lg">+91-9654853181, 8595152392</span>
                            </div>
                            <div className="flex gap-4 my-4">
                                <AiOutlineMail className="text-xl text-white" />
                                <span className="text-white text-lg">rohitkumar9643017@gmail.com</span>
                            </div>
                            <div className="flex gap-4 my-4">
                                <FaLocationDot className="text-2xl text-white" />
                                <span className="text-white text-lg">Tirkha colony Ballabgarh Faridabad (Delhi NCR) Haryana</span>
                            </div>
                        </div>
                    ...
                    <div className="h-auto w-[28rem] flex flex-col items-center bg-white/5 backdrop-blur-lg py-2">
                        <h1 className="text-white text-2xl font-semibold underline">Get in Touch</h1>
                        <form onSubmit={sendEmail} className="mt-6 w-auto p-4 rounded-lg">
                            ...
                            <textarea name="message" placeholder="Your Message" value={formData.message} onChange={handleChange} required className="bg-transparent text-red-500 border border-red-500 h-32 w-full text-[14px] sm:text-[16px] md:text-[18px] lg:text-lg rounded-lg pl-[4px] sm:pl-2 md:pl-3 lg:pl-4 xl:pl-4 mb-4"></textarea>
                            <button type="submit" className=" border-[1px] border-[#ff0000] h-[2rem] sm:h-[2.5rem] md:h-[2.7rem] lg:h-[3.2rem] xl:h-[3.5rem] w-full sm:text-[18px] md:text-[20px] lg:text-lg xl:text-lg rounded-sm sm:rounded-sm md:rounded-md lg:rounded-lg xl:rounded-lg pl-4 outline-none font-semibold bg-[#ff0000] hover:bg-[#000000] uppercase text-white">
