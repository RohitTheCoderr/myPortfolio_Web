...
function Intro() {
  ...
  return (
    <div id='aboutme' className='w-screen py-12 bg-[#ededed] h-auto'>
      <h2 className='text-4xl text-[#ff0000] text-center  uppercase font-DM font-Five'  data-aos="fade-down"> About me </h2>
      <div className='w-[90%] h-auto m-auto mt-12 flex flex-wrap md:flex-nowrap justify-center md:justify-between lg:justify-normal items-center gap-8 md:gap-2 md:space-x-2 lg:space-x-12'>
        <div className=' h-[14rem] sm:h-[20rem] lg:h-[25rem] xl:h-[30rem] w-[14rem] sm:w-[20rem] lg:w-[25rem] xl:w-[30rem] shadow-[#000] shadow-[1px_2px_20px_1px_rgba(0,0,0,0.3)]  flex justify-center items-center rounded-full ' data-aos="fade-right" data-aos-anchor-placement="bottom-bottom"><img src="/rohit-crope.jpg" alt="" className='h-full w-full bg-black rounded-full ' /></div>
