...
const EducationSection = ({ mainHead, title, duration, description, images, isImageLeft }) => {
    ...
    return (
        <div
            className={`w-full h-auto mx-auto py-6 flex ${isImageLeft ? 'bg-[#ededed]' : 'bg-bg'
                } justify-center`}
        >
            <div
            ...
            >
                ...
                <div className="w-full mx-auto md:w-[55%] lg:w-[45%] h-auto font-DM text-slate-700  text-center">
                    <h1 className='text-2xl sm:text-3xl md:text-4xl text-heading'>{mainHead}</h1>
                    <div className='my-2'>
                        <h2 className="text-xl lg:text-2xl italic font-semibold ">{title}</h2>
                        <h4 className="text-lg text-heading font-semibold">Duration : {duration}</h4>
                    </div>
...
function EducationPage() {
    ...
    return (
        <>
            {/* Header Section */}
            <div className=" my-12 sm:text-start tracking-wider">
                <h2 className='text-4xl text-center uppercase italic font-DM font-Five text-heading ' data-aos="fade-down">   My Education </h2>
                <h4 className="text-text text-center text-xl md:text-2xl font-semibold">A Journey of Knowledge and Growth</h4>
            </div>
