...
const Footer2 = () => {
  ...
  return (
    <section className="bg-text py-8 scrollbar-hide">
        ...
        <div className="flex flex-wrap justify-between  gap-4 border-b-2 border-gray-500 pb-4" >
          <div className=" w-auto py-4" data-aos="fade-down">
            <h3 className="flex items-center uppercase text-white text-lg" >
              <FaLink className="text-primary mr-3" />profile link
            </h3>
            <div className="w-8 h-1 bg-primary my-4" ></div>
            <div className="w-auto mt-10 items-start h-auto">
              <div className="flex justify-start gap-0 sm:gap-1 md:gap-4">
                {navItems.map((item, index) => (
                  <NavItem key={index} href={item.href} icon={item.icon} tooltip={item.tooltip} iconbg={" "} liStyle={"w-[3rem]"} />
                ))}
              </div>
            </div>
          </div>
          ...
          <div className="w-auto py-4" data-aos="fade-down">
            <h3 className="flex items-center uppercase text-white text-lg" >
              <FaPhone className="text-primary mr-3" /> Call Us
            </h3>
            <div className="w-8 h-1 bg-primary my-4" ></div>
            <div>
 ...
 {/* Link */}
          <div className="w-auto py-4" data-aos="fade-down">
            <h3 className="flex items-center uppercase text-white text-lg"  >
              <FaGlobe className="text-primary mr-3" /> Link
            </h3>
            <div className="w-8 h-1 bg-primary my-4" ></div>
            <div>
          ...
          <div className=" w-auto py-4" data-aos="fade-down">
            <h3 className="flex items-center uppercase text-white text-lg" >
              <FaLocationDot className="text-primary mr-3" /> Address
            </h3>
            <div className="w-8 h-1 bg-primary my-4" ></div>
            <div>
              <p className="text-gray-400 text-sm">
          ...
          <div className="w-auto py-4" data-aos="fade-down">
            <h3 className="flex items-center uppercase text-white text-lg" >
              <FaEnvelope className="text-primary mr-3" /> Mail Us
            </h3>
            <div className="w-8 h-1 bg-primary my-4" ></div>
            <div>
              <p className="text-gray-400 text-sm">
