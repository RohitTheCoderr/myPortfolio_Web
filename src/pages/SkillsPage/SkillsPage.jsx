        ...
        <>
            <div className='bg-bg py-12'>
                ...
                <div className=' w-[90%] m-auto flex flex-wrap items-center justify-between'>
                    ...
                    <div className=' text-gray-600 md:w-[50%] pb-4 md:p-0 '>
                        <p className='mt-4'>
                        ...
                        <p className='mt-4'>
                            My technical expertise spans frontend technologies, backend development with Node.js and Express, and database management using MongoDB. I am also proficient in utilizing state management libraries like Redux Toolkit and Zustand, ensuring efficient and scalable application performance.
                        </p>
                        <p className='mt-4'>
